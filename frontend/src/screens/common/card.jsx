...
export default function Card(props) {
  return (
    <div
      className="col-lg-4 col-md-6 mb-4 rounded"
      onClick={() => {
    ...
    >
      <div className="card shadow border-0 p-0">
        ...
        >
          <img
            src={props.src}
            className="card-img-top img-fluid embed-responsive-item img-btn w-100 rounded"
            id={props.imgeId}
            style={{ height: "35vh" }}
          />
          <a href="#!">
        ...
        <div className="card-body">
          ...
          <h6 className="mb-3" style={{ color: "#4A60A1" }}>
            {props.price} birr
          </h6>
